...
<head>
    ...
    <title style='color:aquamarine'>PHP Primer - <?php echo $title ?></title>
</head>
<body>

    <h2 style= 'color:aqua'>Hola a todos a mi pagina de PHP</h2>
    <h4 style= 'color:brown'>¿Tu actividad favorita es?</h4>
